...
public class H2DatabaseConnection {
    ...
    public static Connection getConnectionToDatabase() {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
                    "jdbc:h2:mem:shoppingDb;NON_KEYWORDS=USER", "", "");
    ...
    /*
     * Starts the database TCP server in case one needs to access it using a 3rd
     * party(external) client
     *
     */
     ...
     * Runs all the queries from the file to create tables, insert records and make
     * it ready to use
     **/
